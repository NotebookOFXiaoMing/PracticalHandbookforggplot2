...
类似于箱线图还有小提琴图的还有 
- 抖动的散点图 geom_jitter()
- 蜂群图 需要借助额外的R包ggbeeswarm https://github.com/eclarke/ggbeeswarm
- 山脊图 借助额外的R包 ggridges https://cran.r-project.org/web/packages/ggridges/vignettes/introduction.html
